      ...
      <div className="home-page container-fluid text-center">
        ...
        <section className="hero hero_section container">
          {isAuthenticated && user ? (
            <>
              <h1 className="text-primary display-4 fw-bold" data-aos="fade-up">Welcome back, {user.name}!</h1>
              <p className="lead text-secondary hero_section_p" data-aos="fade-up">
                Ready to conquer some more challenges?
              </p>
          ...
          <div className="row g-4 mb-4">
            <div className="col-lg-4 col-md-6 col-sm-12" data-aos="flip-up">
              <div className="text-start h-100 custom_col rounded p-4 glass-card">
                ...
                <p>Solve curated problems across Arrays, Strings, DP, Trees, and more.</p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-12" data-aos="flip-up">
              <div className="text-start h-100 custom_col rounded p-4 glass-card">
                <h3 className="pb-2">Real-Time Code Evaluation</h3>
                <p>Instant feedback on submissions with input/output and explanation.</p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-12" data-aos="flip-up">
              <div className="text-start h-100 custom_col rounded p-4 glass-card">
                <h3 className="pb-2">Company-Wise Questions</h3>
                <p>Master top tech interviews with problems asked by Google, Amazon, etc.</p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-12" data-aos="flip-up">
              <div className="text-start h-100 custom_col rounded p-4 glass-card">
                <h3 className="pb-2">Profile & Coding Graph</h3>
                <p>Track your daily progress, submission streaks, and improvement curve.</p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-12" data-aos="flip-up">
              <div className="text-start h-100 custom_col rounded p-4 glass-card">
                <h3 className="pb-2">Progress Tracker</h3>
                <p>Visualize your topic-wise coverage and stay on top of your learning goals.</p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-12" data-aos="flip-up">
              <div className="text-start h-100 custom_col rounded p-4 glass-card">
                <h3 className="pb-2">Admin Panel for Problems</h3>
                <p>Easily add, update, and manage problem sets with rich metadata.</p>
              </div>
            </div>
          </div>
        </section>
