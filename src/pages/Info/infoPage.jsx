  ...
  return (
    ...
    <div className="mt-5 col-3 sidebar d-flex flex-column">
        <div className="first d-flex flex-column">
            <h3 className='p-3' style={{background : '#212529',borderTopRightRadius : '20px',borderTopLeftRadius : '20px'}}>Introduction</h3>
        ...
        <div className="mt-4 first d-flex flex-column">
            <h3 className='p-3' style={{background : '#212529',borderTopRightRadius : '20px',borderTopLeftRadius : '20px'}}>Variable and Data Types</h3>
        ...
        <div className="mt-4 first d-flex flex-column">
            <h3 className='p-3' style={{background : '#212529',borderTopRightRadius : '20px',borderTopLeftRadius : '20px'}}>Looping in ...</h3>
