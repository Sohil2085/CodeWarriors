...
const AboutPage = () => {
  return (
    ...
    <div className="container-fluid custom_class">
      ...
      <h2 className='fw-bold'>How to Use Code Warriors</h2>
      <ol>
